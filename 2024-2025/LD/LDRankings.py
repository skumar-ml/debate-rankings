...
ddTeams = []
with open("24-25-LDCT-Roster.csv", "r") as fp:
    for line in fp:
...
add_tournament("New York", 8)
add_tournament("JW Patterson", 1)
add_tournament("Heart of Texas", 8)
...
add_tournament("LaCostaCanyon", 1)
add_tournament("Cypress", 1)
...
add_tournament("Sunvitational", 1)
...
add_tournament("UniversityOfHouston", 2)
