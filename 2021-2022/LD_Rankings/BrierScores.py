...
with open("LDRankings.csv","r") as file:
    for line in file:
        line = line.split(",")
        elos[line[1]] = line[3]
...
print(brier_prelims("Ridge", elos))
print(brier_elims("Ridge", elos))
print(brier_prelims("Strake", elos))
print(brier_elims("Strake", elos))
print(brier_prelims("Blake", elos))
print(brier_elims("Blake", elos))
